...
const OrderForm = props => (
  <Row>
    ...
    <Button
      disabled={!props.options.name.length >0 && !props.options.contact.length > 0}
      onClick={() => sendOrder(props.options, props.tripCost, props.tripName, props.tripId, props.tripCountry)}>
      Order now!
    </Button>
  </Row>
);
